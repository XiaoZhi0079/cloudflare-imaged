...
import { registerAiOrganizationTools } from "./tools/ai-organization-tools.js";
...
async function main(): Promise<void> {
  ...
  const server = new McpServer({ name: "gallery-mcp-server", version: "0.13.0" });
  ...
  registerAiOrganizationTools(server, api);
